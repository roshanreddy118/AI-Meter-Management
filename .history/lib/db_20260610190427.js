...
export const addProperty = async (name, address) => {
  try {
    const result = await sql`
...
export const getReadings = async (propertyId) => {
  try {
    const result = await sql`
...
export const addMeterReading = async (propertyId, readingDate, meterReading, photoUrl) => {
  try {
    // Get BESCOM rate
...
export const updatePaymentStatus = async (readingId, paymentStatus) => {
  try {
    const result = await sql`
...
export const updateSettings = async (bescomRate) => {
  try {
    const result = await sql`
      UPDATE settings 
